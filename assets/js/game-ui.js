class GameUI {
  ...
  DisplayStart() {
    ...
    dialog.Display(`
            ...
            <img class ="img-meow" src="./assets/IMG/MEOW.png" alt="Cat saying meaow">
            <img class ="img-eyes" src="./assets/IMG/cat-eyes.png" alt="Cat eyes">
  ...
  DisplayScoreboard(game, name) {
    ...
    database.Get((data) => {
      ...
      for (
        ...
        listElementsHtml += `<li><span class= "scoreboard-place">${
          i + 1
        }</span> <span class= "scoreboard-name">${
          record.name
        }</span> <span class= "scoreboard-score">${record.time}s, ${
          record.speed
        }k/s)</span></li>`;
      }
